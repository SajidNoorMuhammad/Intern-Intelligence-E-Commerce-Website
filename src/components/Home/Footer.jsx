        ...
        <footer className="bg-gray-900 text-gray-300 py-10 mt-10">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p className="text-sm mt-2">UAN: 021-11-11-CHASE</p>
            ...
            {/* Payment Icons */}
            <div className="mt-10 border-t border-gray-700 pt-6 px-4 flex flex-wrap justify-center gap-6 rounded-full">
                <img src="/Images/Payment/payment_icon_1.png" alt="payment1" className="h-16 rounded-full" />
                <img src="/Images/Payment/payment_icon_2.png" alt="payment2" className="h-16 w-15 rounded-full" />
                <img src="/Images/Payment/payment_icon_3.png" alt="payment3" className="h-16 rounded-full" />
                <img src="/Images/Payment/payment_icon_4.png" alt="payment4" className="h-16 rounded-full" />
                <img src="/Images/Payment/payment_icon_5.svg" alt="payment5" className="h-16 rounded-full" />
            </div>
